/*
  ...
  - animation_wave_inverse.h (animazione onda inversa)
  ...
  - animation_pattern3.h (animazione pattern ogni 3 LED)
  ...
  TB2 (Pin D4) - Controllo animazioni e luminosità:
    - Pressione BREVE (< 500ms): cambia l'animazione corrente
      Sequenza: Bianco fisso → Colori casuali → Rainbow → Onda → Onda inversa
                → Onda graduale → Onda variabile → Pattern 3 LED → Bianco fisso
  ...
  if (!TB2_pressed && TB2_aux) {
    ...
    if (pressDuration < LONG_PRESS_TIME && lampOn) {
      ...
      switch(currentAnimation) {
        ...
        case 3: Serial.println("Onda di luci"); break;
        case 4: Serial.println("Onda inversa"); break;
        case 5: Serial.println("Onda graduale"); break;
        case 6: Serial.println("Onda velocità variabile"); break;
        case 7: Serial.println("Pattern 3 LED"); break;
      }
    }
